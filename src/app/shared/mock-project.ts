...
export const projects: Project[] = [
  ...
  {
    title: 'Hop box',
    description: '<i>Avec Hop Box, rangez malin !</i> Projet en cours de refonte d\'un site web e-commerce pour un mobilier de rangement d\'angle personnalisable.',
    slug: 'hop-box',
    images: [
      {
  ...
  {
    title: 'The Coffret',
    description: '<i>Offrez un coffret cadeau qui est sûr de faire plaisir !</i> Créations graphique pour la marque The Coffret, coffrets cadeaux pour les particuliers et professionnels',
    slug: 'the-coffret',
    images: [
      {
  ...
  {
    title: 'Artizz',
    description: 'Une association pour grouper les artisans de la région iséroise, crée dans le but d\'apporter du poids et de la visibilité. Le projet est de créer un logo et un site vitrine présentant Artizz',
    slug: 'artizz',
    images: [
      {
